    ...
    <div className="page">
      ...
      <div className="page-content">
            ...
            <div className="foundation-stage-content">
              <div className="foundation-content-wrapper">
                <div className="foundation-socialist">
                  <p className="foundation-stage-intro">
                    Khi miền Bắc quá độ lên CNXH, quan điểm xây dựng văn hóa
                    được nâng lên một tầm cao mới:
                  </p>
                  <div className="socialist-intro">
                    <p className="socialist-main-text">
                      Nền văn hóa có <strong>nội dung Xã hội chủ nghĩa</strong>{" "}
                      và <strong>tính chất Dân tộc</strong>.
                    </p>
                  </div>
                ...
                <div className="foundation-main-image">
                  <img
                    src="/namdinh.jpg"
                    alt="Chủ tịch Hồ Chí Minh đến thăm Nhà máy dệt Nam Định"
                  />
                  <p className="image-caption">
        ...
        <div className="page-navigation">
          <Link to="/vai-tro" className="prev-page-link">
            <span className="nav-arrow">←</span>
            <span>Vai trò Văn hóa</span>
          </Link>
          <Link to="/phat-trien" className="next-page-link">
            <span>Tiếp theo: Vận dụng và Thực tiễn</span>
            <span className="nav-arrow">→</span>
          </Link>
        </div>
      </div>
