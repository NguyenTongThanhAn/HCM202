      ...
      <div className="quiz-container">
        <div className="quiz-layout">
                ...
                {questions.map((q, index) => {
                  ...
                  return (
                    <button
                      ...
                      title={
                        isAnswered
                          ? `Đã trả lời: ${userAnswer} ${isCorrect ? '(Đúng)' : '(Sai)'}`
                          : 'Chưa trả lời'
                      }
                    >
                      {q.id}
          ...
          <div className="question-header">
            <span className="question-number">Câu {currentQuestion.id}</span>
          </div>
              ...
              return (
                <button
                  ...
                  className={`option-button ${
                    ...
                    showAnswer && !isSelected && isCorrectOption ? 'correct-not-selected' : ''
                  }`}
        ...
        <div className="modal-overlay" onClick={cancelReset}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="modal-warning">
              Tất cả câu trả lời và điểm số hiện tại sẽ bị xóa và không thể khôi phục.
            </p>
