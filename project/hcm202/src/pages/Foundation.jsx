  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <p className="page-subtitle">Xây dựng nền văn hóa mới: Toàn diện - Khoa học - Nhân văn</p>
      </div>
      ...
      <div className="page-content">
        ...
        <section className="foundation-section">
          <div className="foundation-stage-card">
            <div className="foundation-stage-header">
              <h2 className="foundation-stage-title">1. GIAI ĐOẠN 1: ĐỊNH HÌNH NỀN MÓNG (TRƯỚC 1945)</h2>
            </div>
            <div className="foundation-stage-content">
              <p className="foundation-stage-intro">
                Vào tháng 8/1943, trong khi đưa ra quan niệm về ý nghĩa của văn hóa, Hồ Chí Minh đã xác định 5 nội dung cốt lõi để xây dựng nền văn hóa dân tộc:
              </p>
              ...
              <div className="foundation-pillars">
                ...
                <div className="foundation-pillar">
                  ...
                  <p className="pillar-content">Biết hy sinh cái "tôi" nhỏ bé để làm lợi cho quần chúng.</p>
                </div>
                <div className="foundation-pillar">
                  <div className="pillar-icon">🤝</div>
                  <h3 className="pillar-title">Xây dựng Xã hội</h3>
                  <p className="pillar-content">Hướng tới mọi sự nghiệp liên quan đến phúc lợi của nhân dân.</p>
                </div>
                <div className="foundation-pillar">
                  <div className="pillar-icon">⚖️</div>
                  <h3 className="pillar-title">Xây dựng Chính trị</h3>
                  <p className="pillar-content">Thực hiện dân quyền (quyền của dân).</p>
                </div>
                <div className="foundation-pillar">
                  <div className="pillar-icon">💰</div>
                  <h3 className="pillar-title">Xây dựng Kinh tế</h3>
                  <p className="pillar-content">Kiến thiết nền kinh tế vững chắc.</p>
                </div>
              </div>

              <div className="foundation-note">
                <p>
                  <strong>Nhận xét:</strong> Ngay từ đầu, Bác đã nhìn nhận văn hóa không chỉ là văn chương nghệ thuật mà bao trùm cả kinh tế, chính trị và tâm lý xã hội.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="foundation-section">
          <div className="foundation-stage-card">
            <div className="foundation-stage-header">
              <h2 className="foundation-stage-title">2. GIAI ĐOẠN 2: TRONG KHÁNG CHIẾN CHỐNG PHÁP</h2>
            </div>
            <div className="foundation-stage-content">
              <p className="foundation-stage-intro">
                Khi cả dân tộc bước vào cuộc kháng chiến trường kỳ gian khổ, Hồ Chí Minh khẳng định lại phương châm chiến lược trong "Đề cương văn hóa Việt Nam" (1943). 
                Nền văn hóa mới phải đảm bảo 3 tính chất:
              </p>
        ...
        <section className="foundation-section">
          <div className="foundation-conclusion">
            <h2 className="foundation-conclusion-title">KẾT LUẬN: DIỆN MẠO NỀN VĂN HÓA VIỆT NAM</h2>
            <div className="foundation-conclusion-content">
              <p className="foundation-conclusion-text">
                Tổng hợp lại, quan điểm của Hồ Chí Minh về xây dựng nền văn hóa mới là:
              </p>
